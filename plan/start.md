...
IMPORTANT: The response of the OpenAI API call should never hallucinate answers. If the user asks for an algorithm that solves a problem nobody has solved before, the LLM should not try to implement the algorithm. Instead, the LLM should say "I don't know how to implement this, as a well-known solution has not been discovered yet".
